...
export default {
  ...
  ,
  created () {
    console.log(this.subkey, "subkey")
  },
  mounted () {
    console.log("打开子拓扑图")
    const fontSize = 10;
    ...
    class subTogo {
      ...
      initNode () {
        ...
        //节点标题
        this.drawNodeTitle();
        // this.drawNodeCode("database");
        // this.drawNodeCode("cloud");
        // this.drawNodeCode("earth");
        // this.drawNodeCode("docker");
      }

      // 画已配置标识
      // drawNodeCode (code) {
      //   this.nodeCodes = this.nodes.filter(item => item.type == code)
      //     .append('g')
      ...
      //     // .text(item => item.code);
      //     .attr("style", "font-size:18px;line-height:27px")
      //     .text("√");
      // }
